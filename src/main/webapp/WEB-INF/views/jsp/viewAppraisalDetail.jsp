...
<title>Appraisal Detail Page</title>
...
<body>
	...
	<c:if test="${appCycle == 'H1'}">
		...
		<%-- 	<c:choose>
		<c:when test="${appCycle == H1 }"> --%>

		<%-- 			 loop for popluating the H1 related value: starts here --%>
		<%
				for (int i = 0; i <= applist.size() - 1; i++) {
			%>

		<div class="main-wrapper">
			<%="Welcome to Appraisal Details of the Employee"%>
	...
	<c:if test="${appCycle == 'H2'}">
		...
		<%-- 	 loop for popluating the H2 related value: starts here --%>
		<%
				for (int i = 0; i <= applist.size() - 1; i++) {
			%>
						...
						<div class="row">
							...
							<div class="col-xs-4 text-center">
								<input type="text" value="" placeholder="Project H1"
									class="input-sm" name="eprojecth1" />
							</div>
							<div class="col-xs-4 text-center">
								<input type="text" value="<%=applist.get(i).getCycleProject()%>"
